...
<br/><span>Last Updated On 27-Nov-2023</span>
<br/><span>Effective Date 25-Nov-2023</span>

<p className="privacy-policy-p">
    This Privacy Policy describes the policies of

    Soundriser,
    Via Emilia 7, Pogliano Milanese,
    Milan
    20005,
    Italy,
    email: info@soundriser.app,
    phone: +393314110586

    on the collection,
    use and disclosure of your information that we collect
    when you use our website ( https://soundriser.app ).
...
<ol className="privacy-policy-ol">
    ...
    <li>
        ...
        <p className="privacy-policy-p">
            ...
            <a href="https://soundriser.app">Cookie Policy.</a>
        </p>
    </li>
